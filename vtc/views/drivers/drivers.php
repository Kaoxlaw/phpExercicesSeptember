<div class="container">
  <table class="table">
    ...
    <tbody>
      ...
      ?>
        <td>
          <img src='./Ressources/icons/delete.png' style='width:30px;height:30px;' data-toggle="modal" data-target="#exampleModal-<?php echo $drivers->getIdDrivers(); ?>">
        </td>

        <!-- Modal -->
        <div class="modal fade" id="exampleModal-<?php echo $drivers->getIdDrivers(); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
